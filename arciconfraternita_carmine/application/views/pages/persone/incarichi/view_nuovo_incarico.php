<form>
	<div class="form-group">
		<div class="row">
			<div class="col-lg-12">
				<label>Nome*</label>
				<input name="nome" type="text" class="form-control" placeholder="Nome dell'incarico" control="not_null">
			</div>
		</div>
...
$('#salva').click(function(){
	...
	btn.button('loading');
	$.ajax({
		url: "<?php echo site_url('incarichi/ajax_insert_incarico'); ?>",
		type: "POST",
		dataType: "json",
		data: ajax_data,
		success: function(msg) {
			my_alert('Incarico aggiunto [id: '+msg['last_insert_id']+']', 0);
            //reset della form
            $('input').val('');
            $('textarea').val('');
            btn.button('reset');
        ...
        error : function (msg) {
        	my_alert('Incarico non aggiunto', 1);
        	ajax_error_show(msg);
        	btn.button('reset');
        }
    });
